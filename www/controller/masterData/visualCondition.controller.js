sap.ui.define(["com/sap/build/standard/brfAppDeGraosModoEditar/controller/MainController",
	...
	return MainController.extend("com.sap.build.standard.brfAppDeGraosModoEditar.controller.masterData.visualCondition", {

		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getRoute("masterData.visualCondition").attachPatternMatched(this.handleRouteMatched, this);
		...
		getParameters: function (status) {
			...
			var oTableModel = this.getView().getModel("filterVisualCondition");
			oTableModel.setProperty("/itemVisualCondition", []);
			...
			oModel.read("/Warehouse_Visual_Condition", {
				...
				success: function (result) {
					...
					if (result.results.length > 0) {
						oTableModel.setProperty("/itemVisualCondition", result.results);
		...
		_onSave: function (oEvent) {
			...
			var oCreateModel = this.getView().getModel("visualConditionFormModel");
			...
			oModel.createEntry("/Warehouse_Visual_Condition", {
		...
		_openDialogCertification: function () {
			if (!this._FragmentPrice) {
				this._FragmentPrice = sap.ui.xmlfragment("tablePriceId" + this.getView().getId(),
					"com.sap.build.standard.brfAppDeGraosModoEditar.view.masterData.fragments.visualConditionFragment",
					this);
			...
			this.getView().setModel(oModelCertification, "visualConditionFormModel");
		...
		_onDeleteButton: function(oEvent){
			...
			var sPlit = oItem.oParent.oParent.oBindingContexts.filterVisualCondition.sPath.split("/");
			var sIndex = sPlit[2];
			var oData = oItem.oParent.oParent.oBindingContexts.filterVisualCondition.oModel.oData.itemVisualCondition[sIndex];
			var oModel = this.getOwnerComponent().getModel();
				...
				"Deseja Inativar o parâmetro?", {
					...
					onClose: function (oAction) {
						...
						if (oAction === "YES") {
							...
							sPath = this.buildEntityPath("Warehouse_Visual_Condition", oProperties, "HCP_ID");
