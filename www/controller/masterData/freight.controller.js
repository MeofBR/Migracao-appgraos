sap.ui.define(["com/sap/build/standard/brfAppDeGraosModoEditar/controller/MainController",
	...
	return MainController.extend("com.sap.build.standard.brfAppDeGraosModoEditar.controller.masterData.freight", {

		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getRoute("masterData.freight").attachPatternMatched(this.handleRouteMatched, this);
		...
		getParameters: function (status) {
			...
			var oTableModel = this.getView().getModel("filterParemeters");
			oTableModel.setProperty("/itemParameters", []);
			
			oModel.read("/Parameters", {
				...
				success: function (result) {
					...
					if (result.results.length > 0) {
						oTableModel.setProperty("/itemParameters", result.results);
		...
		changeFreight: function(oEvent){
			...
			sPath = this.buildEntityPath("Parameters", oProperties, "HCP_ID");
