(function () {
		...
		(function (Buffer) {
			...
			var GraphHelper = function () {
				...
				GraphHelper.serializeContent = function (content) {
					...
					if (className === "Buffer" || className === "Blob" || className === "File" || className === "FormData" || typeof content ===
						"string") {
						return content
					}
					if (className === "ArrayBuffer") {
						content = Buffer.from(content)
					} else if (className === "Int8Array" || className === "Int16Array" || className === "Int32Array" || className === "Uint8Array" ||
						className === "Uint16Array" || className === "Uint32Array" || className === "Uint8ClampedArray" || className === "Float32Array" ||
						className === "Float64Array" || className === "DataView") {
	...
	3: [function (require, module, exports) {
		...
		var GraphRequest = function () {
			...
			GraphRequest.prototype.addCsvQueryParameter = function (propertyName, propertyValue, additionalProperties) {
				this.urlComponents.oDataQueryParams[propertyName] = this.urlComponents.oDataQueryParams[propertyName] ? this.urlComponents.oDataQueryParams[
					propertyName] + "," : "";
				var allValues = [];
			...
			ResponseHandler.init = function (res, err, resContents, callback) {
				if (res && res.ok) {
					...
					if (err == null && res != null)
						if (resContents != null && resContents.error != null) callback(ResponseHandler.buildGraphErrorFromResponseObject(resContents.error,
							res.status), null, res);
						else callback(ResponseHandler.defaultGraphError(res.status), null, res);
					else callback(ResponseHandler.ParseError(err), null, res)
				}
			};
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (_a) {
							...
							case 2:
								...
								if (batchRequestData.body !== undefined && (batchRequestData.headers === undefined || batchRequestData.headers[
										"content-type"] === undefined)) {
									error = new Error("Content-type header is not mentioned for request #" + requestStep.id +
					...
					return __awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, function (_b) {
							...
							case 0:
								...
								if (!(request.method === RequestMethod_1.RequestMethod.PATCH || request.method === RequestMethod_1.RequestMethod.POST ||
										request.method === RequestMethod_1.RequestMethod.PUT)) return [3, 2];
								_a = requestData;
	...
	13: [function (require, module, exports) {
				...
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_a) {
						...
						case 2:
							...
							return [2, new OneDriveLargeFileUploadTask(client, fileObj, session, {
								rangeSize: rangeSize
							})];
						case 3:
							err_1 = _a.sent();
		...
		"./LargeFileUploadTask": 12,
		"./OneDriveLargeFileUploadTaskUtil": 14
	}],
	...
	16: [function (require, module, exports) {
		...
		function toByteArray(b64) {
			...
			for (var i = 0; i < len; i += 4) {
				tmp = revLookup[b64.charCodeAt(i)] << 18 | revLookup[b64.charCodeAt(i + 1)] << 12 | revLookup[b64.charCodeAt(i + 2)] << 6 |
	...
	18: [function (require, module, exports) {
		(function (process, global) {
			(function (global, factory) {
				typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define
					.amd ? define(factory) : global.ES6Promise = factory()
			})(this, function () {
				"use strict";
