sap.ui.define(["com/sap/build/standard/brfAppDeGraosModoEditar/controller/MainController",
	...
	return MainController.extend("com.sap.build.standard.brfAppDeGraosModoEditar.controller.masterData.certification", {

		onInit: function () {
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getRoute("masterData.certification").attachPatternMatched(this.handleRouteMatched, this);
		...
		getParameters: function (status) {
			...
			var oTableModel = this.getView().getModel("filterCertificates");
			oTableModel.setProperty("/itemCertificates", []);
			...
			oModel.read("/Visit_Certifications", {
				...
				success: function (result) {
					...
					if (result.results.length > 0) {
						oTableModel.setProperty("/itemCertificates", result.results);
		...
		_onSave: function (oEvent) {
			...
			var oCreateModel = this.getView().getModel("certificationFormModel");
			...
			oModel.createEntry("/Visit_Certifications", {
		...
		_openDialogCertification: function () {
			if (!this._FragmentPrice) {
				this._FragmentPrice = sap.ui.xmlfragment("tablePriceId" + this.getView().getId(),
					"com.sap.build.standard.brfAppDeGraosModoEditar.view.masterData.fragments.certificationFragment",
					this);
			...
			this.getView().setModel(oModelCertification, "certificationFormModel");
		...
		_onDeleteButton: function(oEvent){
			...
			var sPlit = oItem.oParent.oParent.oBindingContexts.filterCertificates.sPath.split("/");
			var sIndex = sPlit[2];
			var oData = oItem.oParent.oParent.oBindingContexts.filterCertificates.oModel.oData.itemCertificates[sIndex];
			var oModel = this.getOwnerComponent().getModel();
				...
				"Deseja Inativar o parâmetro?", {
					...
					onClose: function (oAction) {
						...
						if (oAction === "YES") {
							...
							sPath = this.buildEntityPath("Visit_Certifications", oProperties, "HCP_ID");
